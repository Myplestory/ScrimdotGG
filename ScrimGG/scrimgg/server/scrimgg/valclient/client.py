...
class Client:
    ...
    def __init__(self, auth=None, region="na"):
        '''
    ...
    def party_change_to_custom(self) -> dict: 
        '''
        Party_MakePartyIntoCustomGame
        Sets lobby to custom gamemode
        '''
        party_id = self.__get_current_party_id()
        data = self.post(endpoint=f"/parties/v1/parties/{party_id}/makecustomgame",endpoint_type="glz",json_data={})
        return data 
