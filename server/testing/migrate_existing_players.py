...
async def migrate_players():
    ...
    print("     - If ELO > 4000: MMR = ELO × 0.95 (slightly deflate)")
    print("     - If ELO <= 4000: MMR = ELO × 1.05 (slightly inflate)")
    print("  3. Set TrueSkill components based on MMR")
    print("  4. Mark as settled (σ = 2.5, moderate confidence)")
    ...
    for player in players:
        try:
            ...
            if migrated_count <= 3:
                ...
                print(f"      TrueSkill: μ={trueskill_mu:.2f}, σ={trueskill_sigma:.2f}")
...
async def verify_migration():
    ...
    if issues:
        ...
        for p in sample:
            ...
            print(f"    TrueSkill: μ={p.trueskill_mu:.2f}, σ={p.trueskill_sigma:.2f}")
