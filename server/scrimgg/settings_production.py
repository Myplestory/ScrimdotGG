...
# SECURE_SSL_REDIRECT: explicitly disable SSL redirect when env var is False
# This allows HTTP-only deployments (like AWS ECS without ALB SSL termination)
...
if not DEBUG:
    ...
    # Only enable HSTS if SSL redirect is enabled
